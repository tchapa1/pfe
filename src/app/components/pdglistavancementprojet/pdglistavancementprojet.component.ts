...
@Component({
  selector: 'app-pdglistavancementprojet',
  templateUrl: './pdglistavancementprojet.component.html',
  styleUrls: ['./pdglistavancementprojet.component.css']
})
export class PdglistavancementprojetComponent implements OnInit {
  
  avancementprojet:any = [];
  constructor(private apiService: ApipdgavancementprojetService) { 
