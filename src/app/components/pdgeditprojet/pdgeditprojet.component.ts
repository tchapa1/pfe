...
@Component({
  selector: 'app-pdgeditprojet',
  templateUrl: './pdgeditprojet.component.html',
  styleUrls: ['./pdgeditprojet.component.css']
})
export class PdgeditprojetComponent implements OnInit {
