...
@Component({
  selector: 'app-chefeditavancementtache',
  templateUrl: './chefeditavancementtache.component.html',
  styleUrls: ['./chefeditavancementtache.component.css']
})
export class ChefeditavancementtacheComponent implements OnInit {
