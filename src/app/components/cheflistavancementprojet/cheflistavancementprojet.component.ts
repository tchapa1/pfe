...
@Component({
  selector: 'app-cheflistavancementprojet',
  templateUrl: './cheflistavancementprojet.component.html',
  styleUrls: ['./cheflistavancementprojet.component.css']
})
export class CheflistavancementprojetComponent implements OnInit {
  
  avancementprojet:any = [];
  constructor(private apiService: ApichefavancementprojetService) { 
