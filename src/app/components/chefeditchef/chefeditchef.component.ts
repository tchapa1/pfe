...
@Component({
  selector: 'app-chefeditchef',
  templateUrl: './chefeditchef.component.html',
  styleUrls: ['./chefeditchef.component.css']
})
export class ChefeditchefComponent implements OnInit {
