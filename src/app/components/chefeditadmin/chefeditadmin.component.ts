...
@Component({
  selector: 'app-chefeditadmin',
  templateUrl: './chefeditadmin.component.html',
  styleUrls: ['./chefeditadmin.component.css']
})
export class ChefeditadminComponent implements OnInit {
