...
@Component({
  selector: 'app-pdglistprojet',
  templateUrl: './pdglistprojet.component.html',
  styleUrls: ['./pdglistprojet.component.css']
})
export class PdglistprojetComponent implements OnInit {

  
  
  projet:any = [];
  constructor(private apiService: ApipdgprojetService) { 
    this.readprojet();
  }
  ngOnInit() {}
  readprojet(){
