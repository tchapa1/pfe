...
@Component({
  selector: 'app-pdgcreateavancementprojet',
  templateUrl: './pdgcreateavancementprojet.component.html',
  styleUrls: ['./pdgcreateavancementprojet.component.css']
})
export class PdgcreateavancementprojetComponent implements OnInit {
