...
@Component({
  selector: 'app-empcreateconge',
  templateUrl: './empcreateconge.component.html',
  styleUrls: ['./empcreateconge.component.css']
})
export class EmpcreatecongeComponent implements OnInit {
