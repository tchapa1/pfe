...
@Component({
  selector: 'app-chefeditnotif',
  templateUrl: './chefeditnotif.component.html',
  styleUrls: ['./chefeditnotif.component.css']
})
export class ChefeditnotifComponent implements OnInit {
