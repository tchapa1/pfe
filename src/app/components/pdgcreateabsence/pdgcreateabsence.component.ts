...
@Component({
  selector: 'app-pdgcreateabsence',
  templateUrl: './pdgcreateabsence.component.html',
  styleUrls: ['./pdgcreateabsence.component.css']
})
export class PdgcreateabsenceComponent implements OnInit {
