...
@Component({
  selector: 'app-pdgedittache',
  templateUrl: './pdgedittache.component.html',
  styleUrls: ['./pdgedittache.component.css']
})
export class PdgedittacheComponent implements OnInit {
