...
@Component({
  selector: 'app-pdglistabsence',
  templateUrl: './pdglistabsence.component.html',
  styleUrls: ['./pdglistabsence.component.css']
})
export class PdglistabsenceComponent implements OnInit {
  
  absence:any = [];
  constructor(private apiService: ApipdgabsenceService) { 
    this.readabsence();
  }
  ngOnInit() {}
  readabsence(){
