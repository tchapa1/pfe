...
@Component({
  selector: 'app-chefcreateprojet',
  templateUrl: './chefcreateprojet.component.html',
  styleUrls: ['./chefcreateprojet.component.css']
})
export class ChefcreateprojetComponent implements OnInit {

  
  submitted = false;
  projetForm: FormGroup;
  projetProfile: any = ['Finance', 'BDM', 'HR', 'Sales', 'chef'];
  constructor(
    public fb: FormBuilder,
    private router: Router,
    private ngZone: NgZone,
    private apiService: ApichefprojetService
  ) {
    this.mainForm();
  }
  ngOnInit() {}
